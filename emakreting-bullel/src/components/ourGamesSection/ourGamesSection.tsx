...
export default function OurGameSection() {
    ...
    let ourGames = [
        ...
        {
            label: <div style={{fontSize: 24, height: "100%", maxWidth: 600}}>[2021-12-28] Isaac game clone: <br/>The
        ...
        {
            label: <div style={{fontSize: 24, height: "100%", maxWidth: 600, float: "right"}}>Taiko game clone
        ...
        {
            label: <div style={{fontSize: 24, height: "100%", maxWidth: 600}}>[2022-08-10] Bullel - eternal storm<br/>Fast-paced
